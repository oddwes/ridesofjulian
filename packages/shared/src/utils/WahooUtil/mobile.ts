...
const hasClientConfig = () => {
  if (!clientId || !clientSecret) {
    console.warn(
      'Wahoo env missing: EXPO_PUBLIC_WAHOO_CLIENT_ID / EXPO_PUBLIC_WAHOO_CLIENT_SECRET'
    );
    return false;
  }
  return true;
...
export const getStoredWahooToken = async (): Promise<string | null> => {
...
export const refreshWahooAccessToken = async (): Promise<WahooTokenResponse | null> => {
